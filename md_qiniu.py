...
安装依赖:
pip install tinify qiniu validators
...
ak = 'c0Q-uzfkAQBMqb8wrkmT_AN9kO8YWMh23KRw79iV'
sk = 'tVoXCxIMHSP_kfVp4eXB6-Cwt1hiek0q3PE2R3cb'
domain = 'rhzexel9n.hb-bkt.clouddn.com' # 上传域名
bucket = 'md-img-v' # 空间名称
...
def cached_img_url(img_loc_path):
    ...
    '''
    db_path = md_loc + '/img_hash_cache.db'
...
if __name__ == '__main__':
    if len(sys.argv) >= 2:
        ...
        md_loc = os.path.abspath(os.path.join(c_p, ".."))
        print('md_loc:' + md_loc)	
